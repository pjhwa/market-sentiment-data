...
소셜 심리 데이터는 **3개 계층**으로 분리되어 있습니다. 이것이 핵심 설계 원칙입니다 — 수집 액터(Hermes/Mac mini)와 소비 액터(SniperBoard)는 GitHub 저장소를 공유 스토리지로 사용해 느슨하게 결합됩니다.

```
┌─────────────────────────┐     ┌──────────────────────────┐     ┌──────────────────────┐
│  계층 1: 수집             │     │  계층 2: 저장             │     │  계층 3: 소비         │
│  (Mac mini 크론)          │     │  (이 GitHub 레포)         │     │  (SniperBoard 등)    │
│                          │     │                           │     │                      │
